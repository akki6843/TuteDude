...
#### Solution :   
&nbsp;&nbsp;&nbsp;&nbsp; The code is available in `Task_1.py` file.  
&nbsp;&nbsp;&nbsp;&nbsp;On executing it. code will go in try block as the `sample.txt` is present. But by switching the commenting between line 9 and 10 you can observe the two scenarios. 
